...
function Footer() {
  return (
    ...
    >
      <Container fluid className="col-lg-11 d-none d-md-block d-lg-block">
              ...
              <li>
                <div>
                  <div className="p-lg-4">
                    ...
                    >
                      American Yacht Group is your exclusive home for everything HCB YACHTS in South Florida
                    </p>
                  </div>
                </div>
              </li>
          ...
          <Col xs={12} lg={6}>
            ...
            >
              <h6 className="m-0" style={{ fontSize: "14px" }}>
                Copyright © 2023 American Yacht Group
              </h6>
              {/* <a
                href="/privacy-policy"
      ...
      <Container className="d-md-none d-lg-none py-3">
